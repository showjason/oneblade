...
func (s *Service) Handle(ctx context.Context, req Request) (Response, error) {
	slog.Debug("[pagerduty] handle called", "operation", req.Operation)
...
func (s *Service) listIncidents(ctx context.Context, params *ListIncidentsParams) (Response, error) {
	slog.Debug("[pagerduty] list_incidents called",
		"limit", params.Limit,
	...
	slog.Info("[pagerduty] list_incidents succeeded", "count", len(resp.Incidents))
...
func (s *Service) resolveServiceNamesToIDs(ctx context.Context, serviceNames []string) ([]string, error) {
	slog.Debug("[pagerduty] resolve_service_names_to_ids called", "names", serviceNames)
...
func (s *Service) snoozeAlert(ctx context.Context, params *SnoozeAlertParams) (Response, error) {
	slog.Debug("[pagerduty] snooze_alert called",
	...
	slog.Info("[pagerduty] snooze_alert succeeded", "incident_id", params.IncidentID)
...
func (s *Service) acknowledgeIncident(ctx context.Context, params *AcknowledgeIncidentParams) (Response, error) {
	slog.Debug("[pagerduty] acknowledge_incident called", "incident_id", params.IncidentID)
	...
	slog.Info("[pagerduty] acknowledge_incident succeeded", "incident_id", params.IncidentID)
...
func (s *Service) resolveIncident(ctx context.Context, params *ResolveIncidentParams) (Response, error) {
	slog.Debug("[pagerduty] resolve_incident called", "incident_id", params.IncidentID)
	...
	slog.Info("[pagerduty] resolve_incident succeeded", "incident_id", params.IncidentID)
...
func (s *Service) getIncident(ctx context.Context, params *GetIncidentParams) (Response, error) {
	slog.Debug("[pagerduty] get_incident called", "incident_id", params.IncidentID)

	inc, err := s.client.GetIncidentWithContext(ctx, params.IncidentID)
	if err != nil {
		return Response{Success: false, Message: err.Error()}, nil
	}
	slog.Debug("[pagerduty] get_incident succeeded", "incident_id", params.IncidentID)
